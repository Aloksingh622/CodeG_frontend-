...
const QuestionDetailPage = () => {
  ...
  const fetchQuestion = useCallback(async () => {
        try {
            ...
            const response = await axios_client.get(`/discussion/getQuestion/${id}`);
    ...
    const handleUpvote = async (answerId) => {
        ...
        try {
            const res = await axios_client.patch(
    ...
    const handleDeleteQuestion = async () => {
        ...
        try {
            await axios_client.delete(`/discussion/deleteQuestion/${id}`);
    ...
    const handleDeleteAnswer = async (answerId) => {
        ...
        try {
            await axios_client.delete(`/discussion/deleteAnswer/${answerId}`);
